...
export default async function TableDesSavoirsDashboard() {
  ...
  const joueurs = Object.values(joueursMap).map((j) => ({
    nom: j.nom,
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl px-6 py-4 shadow-2xl">
            <p className="text-zinc-400 text-sm">Mise à jour automatique</p>
            <p className="text-2xl font-bold">Google Sheets connecté</p>
          </div>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 shadow-xl">
            <p className="text-zinc-400 text-sm">Meilleur score moyen</p>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 shadow-xl">
            <p className="text-zinc-400 text-sm">Parties jouées</p>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 shadow-xl">
            <p className="text-zinc-400 text-sm">Nombre de joueurs</p>
